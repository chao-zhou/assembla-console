...
class API(object):
    ...
    def __init__(self, key=None, secret=None):
        ...
        :secret
            ...
            https://www.assembla-console.com/user/edit/manage_clients
        """
        if not key or not secret:
            raise Exception(
                'The Assembla API requires your API \'key\' and \'secret\', '
                'accessible from https://www.assembla-console.com/user/edit/manage_clients'
            )
        self.key = key
        self.secret = secret
